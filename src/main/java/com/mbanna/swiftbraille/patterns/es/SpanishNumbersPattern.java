...
public class SpanishNumbersPattern extends Pattern {
    ...
    //--------------------------------------------------------------------------------------------//
    public SpanishNumbersPattern(Context context, InputConnection inputConnection){
    ...
    public Pattern nextPattern(Context context){
        return new SpanishMathPattern(context, inputConnection);
    }
    //--------------------------------------------------------------------------------------------//
